...
class DifferentialDrive:
    ...
    def setMotorsVel(self, left_motor_omega_radps, right_motor_omega_radps):
        self.left_motor_omega_radps = left_motor_omega_radps
        self.right_motor_omega_radps = right_motor_omega_radps

    def setWheelsVel(self, left_wheel_omega_radps, right_wheel_omega_radps):
        tau = self.gearbox_ratio
    ...
    # the motors
    def setVehicleVel(self, lin_vel_mps, ang_vel_radps):
        r =  self.wheel_radius
        d = self.wheel_distance
        ...
        self.setWheelsVel(left_wheel_omega_radps, right_wheel_omega_radps)